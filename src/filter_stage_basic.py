# ----------------------------------------------------------------------------
# -- Components to make a filter stage
# -- Originally designed in OpenSCAD, translation to FreeCAD 
# ----------------------------------------------------------------------------
# -- (c) Felipe Machado
...
# idle pulley made of washers and bearings:
# using from top to bottom:
# - washer M6 DIN-9021
# - washer M4 DIN-125
# - bearing 624ZZ
# - washer M4 DIN-125
# - washer M6 DIN-9021
# This group is defined by the diameter of the bolt, in this case is 4
boltidler_d = 4
boltidler_r_tol = kcomp.D912[boltidler_d]['shank_r_tol']
idle_pull_list = kcomp.idpull_dict[boltidler_d]
# total height of the idle pulley group:
idler_h = partgroup.getgroupheight(idle_pull_list)
idler_r = partgroup.getmaxbeardiam(idle_pull_list)/2.
idler_r_xtr = idler_r + 2. # a little bit larger
...
# thickness above and bellow the nut for the screw
nut_holder_thick = 4.
# metric of the nut:
bolttens_d = 4. 
bolttens_r_tol = kcomp.D912[bolttens_d]['shank_r_tol']
...
gt2_z_pos = aluprof_w + 3.5;

tens_pos_h = gt2_z_pos - wall_thick;
...
hold_bas_h = 8.
hold_bas_w = hold_w + 2*aluprof_w  # holder_base_x in oscad
hold_bas_l = aluprof_w;  # holder_base_y in oscad
    ...
    """
         ...
         |______\_______\____|/...... fc_axis_w 
           ...
           fc_axis_l
                            ...
                            / |_______| \            |        |    /      
                    .. ____/  |       |  \____       |________|  /
        hold_bas_z.+..|_::____|_______|____::_|      |___::___|/
