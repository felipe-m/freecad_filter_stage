...
idler_h = getgroupheight(idlerpulley_l)
idler_r = getmaxwashdiam(idlerpulley_l)/2.
idler_r_xtr = idler_r + 2.  #  +2: a little bit larger

largewasher_thick = getmaxwashthick(idlerpulley_l)
